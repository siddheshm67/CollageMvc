...
<form action="add" method="post">
    ...
    <input type="text" class="form-control" name="namString" placeholder="first middle surname">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Email address</label>
    <input type="email" class="form-control" name="emailString" aria-describedby="emailHelp" placeholder="Enter email">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Password</label>
    <input type="password" class="form-control" name="passString" placeholder="Password">
  </div>
 
   <div class="form-group">
    <label for="inputAddress">Address</label>
    <input type="text" class="form-control" name="addString" placeholder="1234 Main St">
  </div>
  <div class="form-group">
    <label for="inputAddress2">Phone NO.</label>
    <input type="text" class="form-control" name="numString" placeholder="+91/XXXXXXXXX">
...
<div class="form-check form-check-inline ">
  ...
  <label class="form-check-label" for="inlineRadio">Female</label>
   ...
   <div class="form-check mt-3">
    ...
    <label class="form-check-label" for="exampleCheck1">I agree to join course</label>
  </div>
